...
/************************************ get{id} *********************************/
exports.postsRouter.get("/:id", authGuardMiddleware_1.authGuardMiddleware, posts_input_value_middleware_1.postTitleValidation, posts_input_value_middleware_1.shortDescriptionTitleValidation, posts_input_value_middleware_1.content, posts_input_value_middleware_1.blogId, validatorMiddleware_1.ValueMiddleware, function (req, res) {
